...
class GW_HUD
{
	...
	class controls {		
		...
		class Money : GW_StructuredTextBox
		{
			...
			x = (STATUS_X) * safezoneW + safezoneX;
			y = (STATUS_Y + (GW_BUTTON_HEIGHT * 4) - (GW_BUTTON_HEIGHT /2)) * safezoneH + safezoneY;
			w = (GW_BUTTON_WIDTH)  * safezoneW;
		...
		class Transaction : GW_StructuredTextBox
		{
			...
			x = (STATUS_X) * safezoneW + safezoneX;
			y = (STATUS_Y + (GW_BUTTON_HEIGHT * 4) - (GW_BUTTON_HEIGHT /2) + GW_BUTTON_HEIGHT - 0.01) * safezoneH + safezoneY;
			w = (GW_BUTTON_WIDTH)  * safezoneW;
			h = (GW_BUTTON_HEIGHT * 1)  * safezoneH;
