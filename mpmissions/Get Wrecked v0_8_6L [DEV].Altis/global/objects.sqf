...
//		NOTE: This compile is in need of a refresh to improve readability and structure
//		I do not recommend editing this configuration unless you know what you are doing.
//		There is a lot of other aspects to it that need to be changed to make a module fully functional.
//
//
